 ...
 * @param {string} selectedText - Selected text to validate
 * @returns {Object} Validation result with isValid and error message
 */
export function validateSelectedText(selectedText) {
 ...
 * @param {number} maxChunks - Max chunks to validate
 * @returns {Object} Validation result with isValid and error message
 */
export function validateMaxChunks(maxChunks) {
 ...
 * @param {number} maxChunks - Max chunks
 * @param {string} selectedText - Optional selected text
 * @param {string} userId - Optional user ID
 * @returns {Object} Validation result with isValid and array of errors
 */
export function validateQueryRequest(query, provider, maxChunks, selectedText = null, userId = null) {
  const errors = [];
 ...
 * @param {string} query - Query to sanitize and validate
 * @returns {Object} Result with sanitized query and validation status
 */
export function sanitizeAndValidateQuery(query) {
 ...
 * @param {string} selectedText - Selected text to sanitize and validate
 * @returns {Object} Result with sanitized text and validation status
 */
export function sanitizeAndValidateSelectedText(selectedText) {
